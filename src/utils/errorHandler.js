 ...
 * 
 * This module provides structured error handling for the LokroBot application.
 * 
 * PHILOSOPHY:
 ...
 * 
 * USAGE:
 * - Throw LokroBotError for application-specific errors
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new LokroBotError(message, type, userMessage, normalizedContext);
}
